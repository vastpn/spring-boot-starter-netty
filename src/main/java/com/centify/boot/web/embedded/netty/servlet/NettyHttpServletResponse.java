...
public class NettyHttpServletResponse implements HttpServletResponse {
    ...
    public NettyHttpServletResponse(ChannelHandlerContext ctx, NettyServletContext servletContext, HttpResponse response) {
    ...
    public HttpResponse getNettyResponse() {
        ...
        headers.set(HttpHeaders.Names.SERVER, servletContext.getServerInfo());
        // TODO cookies
        return response;
    }
