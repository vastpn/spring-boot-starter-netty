...
public class NettyServletWebApplication {
    ...
    @ApiOperation(value="request/response", notes="request/response")
    ...
    @ApiOperation(value = "get @PathVariable {a,b}")
    @GetMapping("/{a}/{b}")
...
//        System.out.println("@PathVariable 参数");
    ...
    @ApiOperation(value = "params @RequestParam ")
    @GetMapping("/reqparam")
    ...
    @ApiOperation(value = "params @RequestBody ")
    @PostMapping("/reqbody")
    public User getDefault(@RequestBody User user){
        return user;
    }

    @ApiOperation(value = "params form ")
    @PostMapping("/form")
    public User getForm(User user){
        return user;
    }

    @ApiOperation(value = "params @RequestParam {file single}")
    @PostMapping("/upload")
    ...
    @ApiOperation(value = "params @RequestParam {file mult}")
    @PostMapping("/files")
